(function () {
  ...
  var TRANSLATIONS = {
    ku: {
      ...
      'nav.student_services': 'خزمەتگوزارییەکان بۆ خوێندکار', 'nav.about_us': 'دەربارەی ئێمە', 'nav.gallery': 'وێنەکان', 'nav.contact': 'پەیوەندی',
      ...
      'sidebar.services': 'تایبەتمەندی بۆ خوێندکار', 'sidebar.about_us': 'دەربارەی ئێمە', 'sidebar.gallery': 'گەلەریی وێنەکان', 'sidebar.register': 'تۆمارکردنی ناو', 'sidebar.login': 'پەیوەندیکردن',
      ...
      'team.eyebrow': 'بەشی پێنجەم', 'team.title': 'ستافی کۆمپانیای پاتیمات', 'team.lead': 'ئێمە تیمێکی پێشەنگ و شارەزایین لێرەین بۆ پێشکەشکردنی باشترین خزمەتگوزاری و ئاسانکاری بۆ ئێوە لە هەموو جیهان.',
    ...
    en: {
      ...
      'nav.about_us': 'About Us', 'nav.gallery': 'Gallery', 'nav.contact': 'Contact',
      ...
      'sidebar.services': 'Student Perks', 'sidebar.about_us': 'About Us', 'sidebar.gallery': 'Photo Gallery', 'sidebar.register': 'Register Now', 'sidebar.login': 'Contact Us',
      ...
      'team.eyebrow': 'Section Five', 'team.title': 'Patimat Company Team', 'team.lead': 'We are a leading and experienced team here to provide the best services and facilitation for you worldwide.',
    ...
    ar: {
      ...
      'nav.about_us': 'من نحن', 'nav.gallery': 'معرض الصور', 'nav.contact': 'تواصل معنا',
      ...
      'sidebar.services': 'مزايا الطلاب', 'sidebar.about_us': 'من نحن', 'sidebar.gallery': 'معرض الصور', 'sidebar.register': 'تسجيل الاسم', 'sidebar.login': 'تواصل معنا',
      ...
      'team.eyebrow': 'القسم الخامس', 'team.title': 'كادر شركة پاتیمات', 'team.lead': 'نحن فريق رائد وذو خبرة هنا لتقديم أفضل الخدمات والتسهيلات لكم في جميع أنحاء العالم.',
