(function () {
  ...
  var TRANSLATIONS = {
    ku: {
      ...
      'nav.home': 'سەرەکی', 'nav.programs': 'خزمەتگوزارییەکانمان', 'nav.russia': 'سکۆلارشیپی ڕووسیا',
      ...
      'sidebar.home': 'سەرەکی', 'sidebar.programs': 'خزمەتگوزارییەکانمان', 'sidebar.russia': 'سکۆلارشیپی ڕووسیا 100%',
      ...
      'hero.card.title': 'دوا وادەی سکۆلارشیپی ڕووسیا',
      'hero.card.text': 'دوا وادە بۆ پێشکەشکردنی داواکاری بۆ سکۆلارشیپی ڕووسیا: 15/2/2025 - کاتێکی کەم ماوە، پەلە بکە لە ناوتۆمارکردن!',
      'hero.card.badge': '15/2/2025 - دوا مۆڵەت',
      ...
      'programs.eyebrow': 'بەشی سێیەم', 'programs.title': 'سکۆلارشیپی ڕووسیا (Russian Scholarship 100%)',
      'programs.lead': 'ئێمە لە کۆمپانیای پاتیمات دڵنیایی (١٠٠٪) دەدەین لە وەرگرتن و بانگهێشتنامە بۆ خوێندن لە ڕووسیا بەم تایبەتمەندییانە:',
    ...
    en: {
      ...
      'nav.home': 'Home', 'nav.programs': 'Our Services', 'nav.russia': 'Russian Scholarship', 'nav.student_services': 'Student Services',
      ...
      'hero.card.title': 'Russia Scholarship Deadline',
      'hero.card.text': 'Deadline for Russian Scholarship: 15/2/2025 - Time is limited, hurry up and register!',
      'hero.card.badge': '15/2/2025 - Deadline',
    ...
    ar: {
      ...
      'nav.home': 'الرئيسية', 'nav.programs': 'خدماتنا', 'nav.russia': 'منحة روسيا', 'nav.student_services': 'خدمات الطلاب',
      ...
      'hero.card.title': 'آخر موعد لمنحة روسيا',
      'hero.card.text': 'آخر موعد للتقديم على منحة روسيا: 15/2/2025 - الوقت محدود، سارع بالتسجيل!',
      'hero.card.badge': '15/2/2025 - الموعد النهائي',
